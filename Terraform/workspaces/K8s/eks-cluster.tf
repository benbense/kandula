  ...
  worker_groups = [
    {
      ...
      additional_security_group_ids = [aws_security_group.all_worker_mgmt.id, aws_security_group.node_exporter_sg_k8s.id, aws_security_group.kube_state_metrics_sg_k8s.id, aws_security_group.consul_sg_k8s.id]
    },
    {
      name                          = "worker-group-2"
